...
Elm.Collision.make = function (_elm) {
      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 switch (_v0.ctor)
                 {case "_Tuple2":
                    return _v0._0 * _v1._1 - _v0._1 * _v1._0;}
                 _U.badCase($moduleName,
                 "on line 51, column 29 to 42");
              }();}
         _U.badCase($moduleName,
         "on line 51, column 29 to 42");
      }();
   });
   var from = F2(function (_v8,
   _v9) {
      return function () {
         switch (_v9.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 {case "_Tuple2":
                    return {ctor: "_Tuple2"
                           ...
                           ,_1: _v9._1 - _v8._1};}
                 _U.badCase($moduleName,
                 "on line 48, column 27 to 39");
              }();}
         _U.badCase($moduleName,
         "on line 48, column 27 to 39");
      }();
   });
   var neg = function (_v16) {
      return function () {
         switch (_v16.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ...
                   ,_1: 0 - _v16._1};}
         _U.badCase($moduleName,
         "on line 44, column 14 to 19");
      }();
   };
   var mul = F2(function (n,_v20) {
      return function () {
         switch (_v20.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ...
                   ,_1: n * _v20._1};}
         _U.badCase($moduleName,
         "on line 41, column 16 to 24");
      }();
   });
   var add = F2(function (_v24,
   _v25) {
      return function () {
         switch (_v25.ctor)
         {case "_Tuple2":
            ...
            return function () {
                 ...
                 {case "_Tuple2":
                    return {ctor: "_Tuple2"
                           ...
                           ,_1: _v33._1 - _v32._1};}
                 _U.badCase($moduleName,
                 "on line 35, column 25 to 37");
              }();}
         _U.badCase($moduleName,
         "on line 35, column 25 to 37");
      }();
   });
   var calcMinkSupport = F3(function (_v40,
   _v41,
   d) {
      return function () {
         switch (_v41.ctor)
      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 switch (_v48.ctor)
                 {case "_Tuple2":
                    return _v48._0 * _v49._0 + _v48._1 * _v49._1;}
                 _U.badCase($moduleName,
                 "on line 31, column 24 to 39");
              }();}
         _U.badCase($moduleName,
         "on line 31, column 24 to 39");
      }();
   });
   var trip = F3(function (a,b,c) {
      return function () {
         var cab = A2(mul,
         A2(dot,a,b),
         c);
         var bac = A2(mul,A2(dot,a,c),b);
         return A2(sub,cab,bac);
      }();
   });
   var perp = F2(function (a,b) {
      return A3(trip,a,b,a);
   });
   var getDirectionVector = F2(function (_v56,
   _v57) {
      return function () {
         switch (_v57.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 {case "_Tuple2":
                    return function () {
                         ...
                         ,_0: _v56._0
                         ,_1: _v56._1});
                         var collinear = _U.eq(d,
                         {ctor: "_Tuple2",_0: 0,_1: 0});
                         return collinear ? {ctor: "_Tuple2"
                                            ,_0: _v56._1
                                            ,_1: 0 - _v56._0} : d;
                      }();}
                 _U.badCase($moduleName,
                 "between lines 86 and 103");
              }();}
         _U.badCase($moduleName,
         "between lines 86 and 103");
      }();
   });
   var isSameDirection = F2(function (a,
   b) {
      return _U.cmp(A2(dot,a,b),
      0) > 0;
   });
   var handle0Simplex = F2(function (a,
   b) {
      return function () {
         var a0 = neg(a);
         var ab = A2(from,a,b);
         var $ = A2(isSameDirection,
         ab,
         a0) ? {ctor: "_Tuple2"
               ,_0: _L.fromArray([a,b])
               ,_1: A2(perp,
   ...
   var handle1Simplex = F3(function (a,
   b,
   c) {
      return function () {
         var ac = A2(from,a,c);
         var ab = A2(from,a,b);
         var abp = A2(perp,ab,neg(ac));
         var acp = A2(perp,ac,neg(ab));
         var a0 = neg(a);
         return A2(isSameDirection,
         abp,
         a0) ? A2(isSameDirection,
         ab,
         a0) ? {ctor: "_Tuple2"
               ,_0: false
               ,_1: {ctor: "_Tuple2"
   ...
   var enclosesOrigin = F2(function (a,
   sim) {
      return function () {
         switch (sim.ctor)
         {case "::": switch (sim._1.ctor)
              {case "::":
                 switch (sim._1._1.ctor)
                   {case "[]":
                      return A3(handle1Simplex,
                        a,
                        sim._0,
                        sim._1._0);}
                   break;
                 case "[]":
                 return A2(handle0Simplex,
                   a,
                   sim._0);}
              break;}
         _U.badCase($moduleName,
         "between lines 173 and 182");
      }();
   });
   var unsafeHead = function (_v69) {
      return function () {
         switch (_v69.ctor)
         {case "::": return _v69._0;}
         _U.badCase($moduleName,
         "on line 25, column 23 to 24");
      }();
   };
   var doSimplex = F5(function (limit,
   depth,
   minkA,
   minkB,
   _v73) {
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 var b = unsafeHead(_v73._0);
                 var a = A3(calcMinkSupport,
                 minkA,
                 minkB,
                 _v73._1);
                 var notPastOrig = _U.cmp(A2(dot,
                 a,
                 _v73._1),
                 0) < 0;
                 var _ = A2(enclosesOrigin,
                 a,
                 _v73._0);
                 ...
                 return notPastOrig ? {ctor: "_Tuple2"
                                      ,_0: false
                                      ,_1: {ctor: "_Tuple2"
                                           ,_0: _L.fromArray([])
                                           ,_1: {ctor: "_Tuple2"
                                                ,_0: $Basics.toFloat(depth)
                                                ,_1: $Basics.toFloat(depth)}}} : intersects ? {ctor: "_Tuple2"
                                                                                              ,_0: true
                                                                                              ,_1: {ctor: "_Tuple2"
                                                                                                   ,_0: _v73._0
                                                                                                   ,_1: a}} : _U.cmp(depth,
                 limit) > 0 ? {ctor: "_Tuple2"
                              ,_0: false
                              ,_1: {ctor: "_Tuple2"
                                   ,_0: newSim
                                   ,_1: newDir}} : A5(doSimplex,
                 limit,
                 depth + 1,
                 minkA,
                 minkB,
         ...
         _U.badCase($moduleName,
         "between lines 153 and 162");
      }();
   });
   var collision = F3(function (limit,
   minkA,
   minkB) {
      return function () {
         var d1 = {ctor: "_Tuple2"
                  ...
                  ,_1: 0.0};
         var d2 = neg(d1);
         var b = A3(calcMinkSupport,
         minkA,
         minkB,
         d2);
         var c = A3(calcMinkSupport,
         minkA,
         minkB,
         d1);
         var cb = A2(from,c,b);
         var c0 = neg(c);
         var d = A2(getDirectionVector,
         cb,
         c0);
         var _ = A5(doSimplex,
         limit,
...
Elm.Turtles = Elm.Turtles || {};
Elm.Turtles.make = function (_elm) {
   "use strict";
   _elm.Turtles = _elm.Turtles || {};
   if (_elm.Turtles.values)
   return _elm.Turtles.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $TurtlesModel = Elm.TurtlesModel.make(_elm),
   $TurtlesView = Elm.TurtlesView.make(_elm);
   var flowerSupport = F2(function (flower,
   _v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 y = $._1;
                 return {ctor: "_Tuple2"
                        ,_0: $Basics.toFloat(x) + _v0._0 + 2
                        ,_1: $Basics.toFloat(y) + _v0._1 + 2};
              }();}
         _U.badCase($moduleName,
         "between lines 90 and 92");
      }();
   });
   var flowerToMink = function (flower) {
      return function () {
         var $ = flower,
         position = $.position;
         return {ctor: "_Tuple2"
   ...
   var turtleSupport = F2(function (turtle,
   _v4) {
      return function () {
         switch (_v4.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 y = $._1;
                 return {ctor: "_Tuple2"
                        ,_0: $Basics.toFloat(x) + _v4._0 + 2
                        ,_1: $Basics.toFloat(y) + _v4._1 + 2};
              }();}
         _U.badCase($moduleName,
         "between lines 77 and 79");
      }();
   });
   var turtleToMink = function (turtle) {
      return function () {
         var $ = turtle,
         position = $.position,
         turtleSpec = $.turtleSpec;
   ...
   var positionedTurtle = F4(function (w,
   h,
   time,
   turtle) {
      return function () {
         ...
         var x = 2 + A4(computeCoordinate,
         position.x - 2,
         boxSizeX,
         $Basics.toFloat(xv),
         relativeTime);
         var y = 2 + A4(computeCoordinate,
         position.y - 2,
         boxSizeY,
         $Basics.toFloat(yv),
         relativeTime);
   ...
   var positionedTurtles = F4(function (w,
   h,
   time,
   turtles) {
      return A2($List.map,
      A3(positionedTurtle,w,h,time),
      turtles);
   });
   ...
   var newTurtleSpecSignal = F2(function (w,
   h) {
      return A2($Signal._op["<~"],
      $TurtlesModel.makeTurtle,
      A2(creationTimeSignal,w,h));
   });
   var newTurtleSignal = F2(function (w,
   h) {
      return function () {
         var makeTurtle = F2(function (_v8,
         spec) {
            return function () {
               switch (_v8.ctor)
         ...
         w,
         h)),
         A2(newTurtleSpecSignal,w,h));
      }();
   });
   var allTurtlesSpecSignal = F2(function (w,
   h) {
      ...
      _L.fromArray([]),
      A2(newTurtleSignal,w,h));
   });
   var turtlesSignal = F2(function (w,
   h) {
      return A2($Signal._op["~"],
      A2($Signal._op["<~"],
      A2(positionedTurtles,w,h),
      clockSignal),
      A2(allTurtlesSpecSignal,w,h));
   });
   var main = function () {
      ...
      h) {
         ...
         h,
         _L.fromArray([])),
         A2(turtlesSignal,w,h));
      });
      return A2(main$,500,500);
   }();
   _elm.Turtles.values = {_op: _op
                         ...
                         ,newTurtleSpecSignal: newTurtleSpecSignal
                         ,newTurtleSignal: newTurtleSignal
                         ,allTurtlesSpecSignal: allTurtlesSpecSignal
                         ,computeCoordinate: computeCoordinate
                         ,positionedTurtle: positionedTurtle
                         ,positionedTurtles: positionedTurtles
                         ,turtlesSignal: turtlesSignal
                         ,main: main
                         ,turtleSupport: turtleSupport
                         ,turtleToMink: turtleToMink
                         ,flowerSupport: flowerSupport
                         ,flowerToMink: flowerToMink};
   return _elm.Turtles.values;
};
Elm.TurtlesModel = Elm.TurtlesModel || {};
Elm.TurtlesModel.make = function (_elm) {
   "use strict";
   _elm.TurtlesModel = _elm.TurtlesModel || {};
   if (_elm.TurtlesModel.values)
   return _elm.TurtlesModel.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "TurtlesModel",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var Flower = function (a) {
      return {_: {},position: a};
   };
   var Turtle = F2(function (a,b) {
      return {_: {}
             ,position: a
             ,turtleSpec: b};
   });
   var TurtleSpec = F3(function (a,
   b,
   c) {
      return {_: {}
             ,creationTime: c
   ...
   _elm.TurtlesModel.values = {_op: _op
                              ,Position: Position
                              ,TurtleSpec: TurtleSpec
                              ,Turtle: Turtle
                              ,Flower: Flower
...
Elm.TurtlesView = Elm.TurtlesView || {};
Elm.TurtlesView.make = function (_elm) {
   "use strict";
   _elm.TurtlesView = _elm.TurtlesView || {};
   if (_elm.TurtlesView.values)
   return _elm.TurtlesView.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "TurtlesView",
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Graphics$Collage = Elm.Graphics.Collage.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   ...
   f) {
      return function () {
         ...
         $Color.yellow,
         $Graphics$Collage.circle($Basics.toFloat(2))));
      }();
   });
   var drawFlowers = F3(function (w,
   h,
   flowers) {
   ...
   turtles) {
      return $Graphics$Element.layers(_L.fromArray([A2(boundingBox,
                                                   w,
                                                   h)
                                                   ,A3(drawTurtles,w,h,turtles)
                                                   ,A3(drawFlowers,
                                                   w,
                                                   h,
                                                   flowers)]));
   });
   _elm.TurtlesView.values = {_op: _op
